        ...
        <div className="justify-between items-center gap-12 md:flex">
          ...
          <div className="flex-1 mt-6 md:mt-0">
            ...
            >
              ...
              <button
                className="block w-auto py-3 px-4 font-medium text-sm text-center text-white bg-indigo-600
            ...
            <a href="#">
              ...
              >
                <g fill="currentColor" clipPath="url(#clip0_910_44)">
                  <path
                    fillRule="evenodd"
                    d="M24 1A24.086 24.086 0 008.454 6.693 23.834 23.834 0 00.319 
                  ...
                  />
                  <path
                    d="M9.089 35.264c-.052.119-.243.154-.398.071-.155-.083-.27-.237-.214-.36.056-.122.242
